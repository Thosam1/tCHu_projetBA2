...
public abstract class MapViewCreator {
    ...
    public static Pane createMapView(ObservableGameState observableGame,
        ...
        for (Route route : ChMap.routes()) {
            // créé un group par route et en faire un enfant de pane
            ...
            groupRoute.setOnMouseClicked(e -> {
                ...
                if (possibleClaimCards.size() == 1) {
                    claimRouteH.onClaimRoute(route, possibleClaimCards.get(0));
                      ...
                      // provoque l'apparition d'un dialogue demandant au joueur
                      // de choisir l'ensemble de cartes qu'il désire utiliser
                      // pour essayer de s'emparer de la route
            ...
            // créé un Group correspondant à chaques cases de la route (autant
