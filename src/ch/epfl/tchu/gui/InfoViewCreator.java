 ...
 * La classe InfoViewCreator consiste en la partie de l'interface montrant : en
 * haut: pour chaque joueur, un disque de la couleur de ses wagons, suivi des
 * statistiques le concernant— nombre de billets et de cartes en main, wagons
 * restants et points de construction obtenus, en bas: les cinq dernières
...
abstract class InfoViewCreator {
    public static VBox createInfoView(PlayerId playerId,
        ...
        List<PlayerId> playerIdList = // TODO adapter cette partie pour un jeu
                                      // avec plus que 2 joueurs
                List.of(playerId, playerId.next());
        ...
        /** Messages */
        //créé le text flow contenant les 5 derniers messages
