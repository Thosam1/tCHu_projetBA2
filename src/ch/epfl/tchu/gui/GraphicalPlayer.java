...
public final class GraphicalPlayer {
     ...
     * 
     * @param newGameState nouveau gameState
     * @param newPlayerState nouveau playerState
     */
     ...
     * 
     * @param drawTicketsHandler le handler du tirage de billets
     * @param drawCardHandler le handler du tirage de cartes
     * @param claimRouteHandler le handler qui se charge de la prise des routes
     */
    ...
    private Button chooseCardsButton(ListView<SortedBag<Card>> list,
        ...
        button.setOnAction(e -> handler.onChooseCards((temp.isEmpty()) ? SortedBag.of()
                : temp.get(0)));
        return button;
    }
